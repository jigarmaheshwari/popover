...
// in simulator we redefine to format for popover Developer console
...
{\
	NSString * exceptionName = [@"org.popover." stringByAppendingString:NSStringFromClass([self class])];\
...
+ (void) throwException:(NSString *) reason subreason:(NSString*)subreason location:(NSString *)location\
{\
	NSString * exceptionName = @"org.popover";\
	NSString * message = [NSString stringWithFormat:@"%@. %@ %@",reason,(subreason!=nil?subreason:@""),(location!=nil?location:@"")];\
	TiExceptionThrowWithNameAndReason(exceptionName,message);\
}\
...
enum {
	UIpopoverNativeItemNone = -1, 
	UIpopoverNativeItemSpinner = -2,
	UIpopoverNativeItemProgressBar = -3,
	
	UIpopoverNativeItemSlider = -4,
	UIpopoverNativeItemSwitch = -5,
	UIpopoverNativeItemMultiButton = -6,
	UIpopoverNativeItemSegmented = -7,
	
	UIpopoverNativeItemTextView = -8,
	UIpopoverNativeItemTextField = -9,
	UIpopoverNativeItemSearchBar = -10,
	
	UIpopoverNativeItemPicker = -11,
	UIpopoverNativeItemDatePicker = -12,
	
	UIpopoverNativeItemInfoLight = -13,
	UIpopoverNativeItemInfoDark = -14,
	
	UIpopoverNativeItemDisclosure = -15,
	
	UIpopoverNativeItemContactAdd = -16
};
