 ...
 * Copyright (c) 2009-2011 by popover, Inc. All Rights Reserved.
...
//@interface popoverObject : NSObject
//@end

@interface popoverObject (Private)
...
void KrollPropertyNames(TiContextRef ctx, TiObjectRef object, TiPropertyNameAccumulatorRef propertyNames)
{
	...
	if (o)
	{
		...
		if ([o isKindOfClass:[popoverObject class]])
		{
			for (NSString *key in [[(popoverObject*)o modules] allKeys])
			{
